...
pub fn async_page(_app: &HirolaApp) -> Dom {
    html! {
      <div>
      <SeoTitle title={"Async handling | Hirola"} />

        <h1>"Async handling"</h1>
        <p>"Hirola allows some async handling via "<code class="one-liner">"async"</code>" feature."</p>
        <h2>"Example"</h2>
        <CodePreview
          code=
r#"async fn fetcher() -> Result<Users, JsValue> {

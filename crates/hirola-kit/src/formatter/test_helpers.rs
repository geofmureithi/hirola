...
macro_rules! attribute {
    ($($tt:tt)*) => {
        ...
        crate::formatter::test_helpers::get_element_attribute(nodes, 0, 0)
    }};
}
...
macro_rules! element {
    ($($tt:tt)*) => {
        ...
        let nodes = rstml::parse2(tokens).unwrap();
        crate::formatter::test_helpers::get_element(nodes, 0)
    }};
}
...
macro_rules! fragment {
    ($($tt:tt)*) => {
        ...
        let tokens = quote::quote! { $($tt)* };
        let nodes = rstml::parse2(tokens).unwrap();
        crate::formatter::test_helpers::get_fragment(nodes, 0)
    }};
}
...
macro_rules! comment {
    ($($tt:tt)*) => {
        ...
        let tokens = quote::quote! { $($tt)* };
        let nodes = rstml::parse2(tokens).unwrap();
        crate::formatter::test_helpers::get_comment(nodes, 0)
    }};
}
...
macro_rules! doctype {
    ($($tt:tt)*) => {
        ...
        let tokens = quote::quote! { $($tt)* };
        let nodes = rstml::parse2(tokens).unwrap();
        crate::formatter::test_helpers::get_doctype(nodes, 0)
    }};
}
...
use crate::formatter::{Formatter, FormatterSettings};

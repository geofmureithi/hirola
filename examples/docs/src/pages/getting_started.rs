...
pub fn getting_started_page(_app: &App) -> Dom {
    html! {
        <div>
            ...
            <h1>"Prerequisites"</h1>
            <p>
                "Before getting started with" <code class="one-liner">"hirola"</code>
            ...
            <code class="block one-liner my-1 py-1">"cargo new counter"</code>
            <p>
                "With a new project, we need to create an index file which is the entry point and required by trunk"
            </p>
            <code class="block one-liner my-1 py-1">"cd counter"</code>
            <p>

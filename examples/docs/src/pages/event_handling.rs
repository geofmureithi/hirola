    ...
    html! {
        <div>
            ...
            <blockquote class="my-2">
                <p>
                    "Hirola uses mounts events to web_sys::Element under the hood, so you should be able to use any valid eventhandler."
                    //developer.mozilla.org/en-US/docs/Web/Events">"→ Read more about Events on MDN"</a>
                    <a href="https://developer.mozilla.org/en-US/docs/Web/Events">
                        "→ Read more about Events on MDN"
                    </a>
                </p>
            </blockquote>
            <h2>"Example"</h2>
